...
exports.loadConfig = exports.TIMEOUT_PLACEHOLDER = void 0;
const cosmiconfig_1 = require("cosmiconfig");
const core_1 = require("@jazzer.js/core");
exports.TIMEOUT_PLACEHOLDER = Number.MIN_SAFE_INTEGER;
// Lookup `Options` via the `.jazzerjsrc` configuration files.
function loadConfig(options = {}, optionsKey = "jazzerjs") {
    ...
    if (config.timeout === undefined) {
        config.timeout = exports.TIMEOUT_PLACEHOLDER;
    }
    ...
    (0, core_1.setParameterResolverValue)(core_1.ParameterResolverIndex.ConfigurationFile, config);
    return (0, core_1.buildOptions)();
}
